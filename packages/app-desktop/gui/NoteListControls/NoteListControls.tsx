...
function NoteListControls(props: Props) {
  ...
  useEffect(() => {
    CommandService.instance().registerRuntime(
      "focusSearch",
      focusSearchRuntime(searchBarRef)
    );
    ...
    return (
      <TopRow className="new-note-todo-buttons">
        <StyledButton
          ...
          tooltip={
            showTooltip ? CommandService.instance().label("newNote") : ""
          }
          iconName={noteIcon}
        ...
        />
        <StyledButton
          ref={newTodoButtonRef}
          className="new-todo-button"
          tooltip={
            showTooltip ? CommandService.instance().label("newTodo") : ""
          }
          iconName={todoIcon}
  ...
  return (
    <StyledRoot
      ...
      buttonVerticalGap={props.buttonVerticalGap}
    >
        ...
        {showsSortOrderButtons() && (
          <SortOrderButtonsContainer>
            ...
            <StyledPairButtonR
              ...
              tooltip={CommandService.instance().label(
...
const mapStateToProps = (state: AppState) => {
  ...
  return {
    ...
    newNoteButtonEnabled: CommandService.instance().isEnabled(
      "newNote",
      whenClauseContext
    ),
    newTodoButtonEnabled: CommandService.instance().isEnabled(
      "newTodo",
      whenClauseContext
    ),
